<x-main-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('events.store') }}" method="POST" x-data="{
                country: null,
                city: null,
                cities: [],
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <input type="text" id="addresss" name="address" value="{{ old('address') }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500"
                        placeholder="Address...">
                    @error('address')
                        <div class="text-sm text-red-400">{{ $message }}</div>
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <label for="num_tickets" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Number
                        of Tickets:</label>
                    <input type="number" id="num_tickets" name="num_tickets" vlaue="{{ old('num_tickets') }}"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500"
                ...
                <div class="grid gap-6 md:grid-cols-2">
                    ...
                    <textarea type="text" id="description" name="description" rows="4"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500"
                        placeholder="Type your thoughts here...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="text-sm text-red-400">{{ $message }}</div>
                    @enderror
                </div>
